...
const Login = () => {
  ...
  return (
      ...
      <div>
        ...
        <form className="form">
          ...
          <div className="inputForm">
            ...
            <input type="password" className="input" name='password' placeholder="Enter your Password" onChange={handleChange} value={password} required />
          ...
          <button className="button-submit" type='submit' onClick={handleSubmit}>Sign In</button>
    ...
    C318.115,0,375.068,22.126,419.404,58.936z"></path>
      ...
      c1.733,0.262,2.963,1.032,3.723,2.22c-1.466,0.933-2.625,2.339-2.427,4.74C17.818,14.688,19.086,15.964,20.67,16.716z"></path>
                  </g>
                </g>
              </svg>
